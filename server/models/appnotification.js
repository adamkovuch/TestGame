...
class AppNotification extends typegoose_1.Typegoose {
}
__decorate([
...
__decorate([
    typegoose_1.prop({ required: true }),
    __metadata("design:type", String)
], AppNotification.prototype, "text", void 0);
__decorate([
...
], AppNotification.prototype, "dt", void 0);
exports.AppNotification = AppNotification;
db_connection_1.DbModels.registerModel(AppNotification);
